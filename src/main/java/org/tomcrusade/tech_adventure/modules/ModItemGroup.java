...
import org.tomcrusade.tech_adventure.modules.materials.templates.MaterialItem;
...
public class ModItemGroup {
  ...
  public ModItemGroup(String key, Item itemForIcon, Text displayName){
    this.key = RegistryKey.of(Registries.ITEM_GROUP.getKey(), Identifier.of(MOD_ID, key));
    this.materialItems = new ArrayList<>();
    this.itemGroup = FabricItemGroup.builder()
      .icon(() -> new ItemStack(itemForIcon))
      .displayName(displayName)
      .build();
    Registry.register(Registries.ITEM, "item_group_" + key, itemForIcon);
